	...
	internal class FilesSorter
	{
			...
			SemaphoreSlim semaphore)
		{
			...
			using (var fileReader = File.OpenRead(inputFileNameWithPath))
			{
				...
				using (var reader = new StreamReader(fileReader, Encoding.UTF8, false, Consts.Megabytes10))
				{
		...
		private static void RewriteTemporaryFile(List<Line> lines, string fileName)
		{
			...
			using var writer = new StreamWriter(stream, Encoding.UTF8, Consts.Megabytes10);
